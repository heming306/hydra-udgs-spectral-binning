...
#SBATCH --output=4_hydra-udgs_selfcal2-1615051332-%j-stdout.log ##updated names
#SBATCH --error=4_hydra-udgs_selfcal2-1615051332-%j-stderr.log ## updated names
...
caracal -c 4_hydra-udgs-selfcal2-1615051332.yml --container-tech singularity -sid /software/astro/caracal/STIMELA_IMAGES_1.7.5
