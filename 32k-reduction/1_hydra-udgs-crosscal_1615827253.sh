...
#SBATCH --output=1_hydra-udgs_crosscal_1615827253-%j-stdout.log ##updated names
#SBATCH --error=1_hydra-udgs_crosscal_1615827253-%j-stderr.log ## updated names
...
caracal -c 1_hydra-udgs_crosscal_1615827253.yml --container-tech singularity -sid /software/astro/caracal/STIMELA_IMAGES_1.7.0
