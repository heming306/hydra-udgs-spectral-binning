...
#SBATCH --output=7_hydra-udgs_cube2-%j-stdout.log ##updated names
#SBATCH --error=7_hydra-udgs_cube2-%j-stderr.log ## updated names
...
caracal -c 7_hydra-udgs-cube2.yml --container-tech singularity -sid /software/astro/caracal/STIMELA_IMAGES_1.7.5
