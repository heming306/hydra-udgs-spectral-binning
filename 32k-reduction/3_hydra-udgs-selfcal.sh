...
#SBATCH --output=1_hydra-udgs_selfcal-%j-stdout.log ##updated names
#SBATCH --error=1_hydra-udgs_selfcal-%j-stderr.log ## updated names
...
caracal -c 3_hydra-udgs-selfcal.yml --container-tech singularity -sid /software/astro/caracal/STIMELA_IMAGES_1.7.0
