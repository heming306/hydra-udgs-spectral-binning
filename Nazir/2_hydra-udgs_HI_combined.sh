...
#SBATCH --mem=100GB
#SBATCH --output=2_hydra-udgs_HI_combined-%j-stdout.log ##updated names
#SBATCH --error=2_hydra-udgs_HI_combined-%j-stderr.log ## updated names
...
caracal -c 2_hydra-udgs_HI_combined.yml --container-tech singularity -sid /software/astro/caracal/STIMELA_IMAGES_1.7.0
