...
#SBATCH --mem=100GB
#SBATCH --output=4_hydra-udgs_HI_1615827253-%j-stdout.log ##updated names
#SBATCH --error=4_hydra-udgs_HI_1615827253-%j-stderr.log ## updated names
...
caracal -c 4_hydra-udgs_HI_1615827253.yml --container-tech singularity -sid /software/astro/caracal/STIMELA_IMAGES_1.7.0
